...
# Unit tests for SDC::Transacao
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'Transacao' do
  before do
    # run before each test
    @instance = SDC::Transacao.new
  end
  ...
  describe 'test an instance of Transacao' do
    it 'should create an instact of Transacao' do
      @instance.should be_a(SDC::Transacao) 
    end
  end
