...
namespace br.com.conductor.sdc.api.v1.invoker;
...
class ApiClient
{
     ...
     * @throws \br.com.conductor.sdc.api.v1.invoker\ApiException on a non 2xx response
     * @return mixed
     */
    public function callApi($resourcePath, $method, $queryParams, $postData, $headerParams, $responseType = null)
    {
        ...
        if ($postData and in_array('Content-Type: application/x-www-form-urlencoded', $headers)) {
            ...
            $postData = json_encode(\br.com.conductor.sdc.api.v1.invoker\ObjectSerializer::sanitizeForSerialization($postData));
        }
